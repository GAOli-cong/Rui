...
import com.glc.myapplication.adapter.ReAdapter;
import com.glc.myapplication.adapter.ReAdapter2;
import com.glc.myapplication.entity.WeatherBean;
...
public class TianQiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lianxiwo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //打开的网址
                intent.setData(Uri.parse("http://www.gaolicong.xyz:8082"));
        ...
        tv_cityName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyDialog myDialog = new MyDialog(TianQiActivity.this);
                myDialog.show();
            }
        });
        //切换触发 dialog
    ...
    private void selectWeather(String cityName) {
        ...
        //注意请将秘钥替换为：自己到京东万象注册账号搜索api 中国和世界天气预报就可以得到了,此处我就把我的key删除了
        String url = "https://way.jd.com/he/freeweather?city=" + cityName + "&appkey=";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, jsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                if(weatherBean.getResult().getHeWeather5().get(0).getStatus().equals("unknown location")){
                    Toast.makeText(TianQiActivity.this, "输入城市有误", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    Toast.makeText(TianQiActivity.this, "更新时间" + weatherBean.getResult().getHeWeather5().get(0).getBasic().getUpdate().getLoc(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError volleyError) {
                Toast.makeText(TianQiActivity.this, "网络有误", Toast.LENGTH_SHORT).show();
                refreshLayout.setRefreshing(false);
            }
        });
            ...
            btn_chaxun.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (editText.getText().toString().equals("")) {
                        Toast.makeText(TianQiActivity.this, "输入为空,重新输入", Toast.LENGTH_SHORT).show();
                    } else {
